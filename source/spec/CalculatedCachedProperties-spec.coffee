describe "CCP:", ->
  ...
  describe "Get classes & calcProperties of inherited classes", ->
    ...
    describe "called on target instance:", ->
      it "#1", ->
        expect(dn.classes).to.deep.equal [CCP, CalculatedCachedProperties2, SelfishNumber, DirtyNumbers ]

      it "#2", ->
        expect(sn.classes).to.deep.equal [CCP, CalculatedCachedProperties2, SelfishNumber]
    ...
    describe "Get all calculated properties, overriding properties in parent classes:", ->
      ...
      describe "with instance as param:", ->
        ...
        describe "called statically (on any class):", ->
          it "#1", ->
            ...
            expect(CCP.getAllCalcProperties dn ).to.deep.equal allDnProperties
          it "#2", ->
            ...
            expect(CCP.getAllCalcProperties sn).to.deep.equal allSnProperties
      ...
      describe "with class as param:", ->
        ...
        describe "called statically (on any class):", ->
          it "#1", ->
            expect(CCP.getAllCalcProperties DirtyNumbers).to.deep.equal allDnProperties
            expect(SelfishNumber.getAllCalcProperties DirtyNumbers).to.deep.equal allDnProperties
          it "#2", ->
            expect(CCP.getAllCalcProperties SelfishNumber).to.deep.equal allSnProperties
